/**
 * @file BaseSensorFuserProcess.hpp
 ...
 */
#pragma once
#include <ISensorFuserProcess.hpp>
...
namespace fast::rf::PerceptionSystem::DepthCameraPipelineSubsystem::SensorFuser {
    /**
     * @brief Base SensorFuser Process
      @details Concrete SensorFuser Processes should derive from this
     *
     */
    class BaseSensorFuserProcess : public ISensorFuserProcess {
       public:
        /**
         * @brief Construct a new Base SensorFuser Process object
         *
         */
        BaseSensorFuserProcess()
            : m_systemId(fast::rf::PerceptionSystem::SYSTEM_ID),
              ...
              m_processId(
                  fast::rf::PerceptionSystem::DepthCameraPipelineSubsystem::SensorFuser::PROCESS_SENSORFUSER_ID),
