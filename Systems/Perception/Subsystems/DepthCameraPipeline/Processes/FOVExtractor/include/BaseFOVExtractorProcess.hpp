/**
 * @file BaseFOVExtractorProcess.hpp
...
namespace fast::rf::PerceptionSystem::DepthCameraPipelineSubsystem::FOVExtractor {
    /**
     * @brief Base FOVExtractor Process
      @details Concrete FOVExtractor Processes should derive from this
     *
     */
    class BaseFOVExtractorProcess : public IFOVExtractorProcess {
       public:
        /**
         * @brief Construct a new Base FOVExtractor Process object
         *
         */
        BaseFOVExtractorProcess()
            : m_systemId(fast::rf::PerceptionSystem::SYSTEM_ID),
              ...
              m_processId(
                  fast::rf::PerceptionSystem::DepthCameraPipelineSubsystem::FOVExtractor::PROCESS_FOVEXTRACTOR_ID),
