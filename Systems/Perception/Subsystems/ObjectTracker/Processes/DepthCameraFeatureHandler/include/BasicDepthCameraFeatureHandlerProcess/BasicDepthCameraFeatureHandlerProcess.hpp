/**
 * @file BasicDepthCameraFeatureHandlerProcess.hpp
...
namespace fast::rf::PerceptionSystem::ObjectTrackerSubsystem::DepthCameraFeatureHandler {
    ...
    class BasicDepthCameraFeatureHandlerProcessConfig {
       public:
        bool isOk() {
            // Add checks here
            return false;
     ...
     *
     */
    class BasicDepthCameraFeatureHandlerProcess : public BaseDepthCameraFeatureHandlerProcess {
       public:
        BasicDepthCameraFeatureHandlerProcess() : BaseDepthCameraFeatureHandlerProcess() {}
        ...
        bool setConfig(BasicDepthCameraFeatureHandlerProcessConfig config) {
       ...
       private:
        BasicDepthCameraFeatureHandlerProcessConfig m_config;
    };
}  // namespace fast::rf::PerceptionSystem::ObjectTrackerSubsystem::DepthCameraFeatureHandler
