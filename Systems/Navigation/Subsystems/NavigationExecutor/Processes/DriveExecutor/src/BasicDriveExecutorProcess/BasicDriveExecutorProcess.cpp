...
IDriveExecutorOutput* BasicDriveExecutorProcess::new_cmd(GeometryMsgs::TwistMsg cmd) {
    IDriveExecutorOutput* output = nullptr;
    return output;
}
bool BasicDriveExecutorProcess::update(double current_time_sec, double delta_time_sec) {
