...
EasyObjectDictionary::EasyObjectDictionary() {
    ...
    int iDS = 0, oDS = 0;
    if (iDS < (int)sizeof(Ep_Request))
        iDS = sizeof(Ep_Request);
    if (iDS < (int)sizeof(Ep_Ack))
        iDS = sizeof(Ep_Ack);
    if (iDS < (int)sizeof(Ep_Status))
        iDS = sizeof(Ep_Status);
    if (iDS < (int)sizeof(Ep_Raw_GyroAccMag))
        iDS = sizeof(Ep_Raw_GyroAccMag);
    if (iDS < (int)sizeof(Ep_Q_s1_s))
        iDS = sizeof(Ep_Q_s1_s);
    if (iDS < (int)sizeof(Ep_Q_s1_e))
        iDS = sizeof(Ep_Q_s1_e);
    if (iDS < (int)sizeof(Ep_Euler_s1_s))
        iDS = sizeof(Ep_Euler_s1_s);
    if (iDS < (int)sizeof(Ep_Euler_s1_e))
        iDS = sizeof(Ep_Euler_s1_e);
    if (iDS < (int)sizeof(Ep_RPY))
        iDS = sizeof(Ep_RPY);
    if (iDS < (int)sizeof(Ep_Gravity))
        iDS = sizeof(Ep_Gravity);
    if (iDS < (int)sizeof(Ep_Combo))
        iDS = sizeof(Ep_Combo);
    oDS = iDS;
    maxSize = oDS;
...
int EasyObjectDictionary::Get_MaxSize() { return maxSize; }
...
int EasyObjectDictionary::Write_Ep_Status(EP_ID_TYPE_ toId,     ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Q_s1_s(EP_ID_TYPE_ toId,                       ///< [INPUT]
                                          uint32 timeStamp,                       ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Raw_GyroAccMag(EP_ID_TYPE_ toId,              ///< [INPUT]
                                                  uint32 timeStamp,              ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Euler_s1_s(EP_ID_TYPE_ toId,                  ///< [INPUT]
                                              uint32 timeStamp,                  ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Q_s1_e(EP_ID_TYPE_ toId,                       ///< [INPUT]
                                          uint32 timeStamp,                       ///< [INPUT]
                                          float q1, float q2, float q3, float q4  ///< [INPUT]
) {
    Ep_Q_s1_e ep_Q_s1_e;
...
int EasyObjectDictionary::Write_Ep_Euler_s1_e(EP_ID_TYPE_ toId,                  ///< [INPUT]
                                              uint32 timeStamp,                  ///< [INPUT]
                                              float psi, float theta, float phi  ///< [INPUT]
) {
...
int EasyObjectDictionary::Write_Ep_RPY(EP_ID_TYPE_ toId,                   ///< [INPUT]
                                       uint32 timeStamp,                   ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Gravity(EP_ID_TYPE_ toId,                               ///< [INPUT]
                                           uint32 timeStamp,                               ///< [INPUT]
...
int EasyObjectDictionary::Write_Ep_Combo(EP_ID_TYPE_ toId,                        ///< [INPUT]
                                         uint32 timeStamp,                        ///< [INPUT]
                                         Ep_Status_SysState sys,                  ///< [INPUT]
                                         int16 roll, int16 pitch, uint16 yaw,     ///< [INPUT]
                                         int32 q1, int32 q2, int32 q3, int32 q4,  ///< [INPUT]
                                         int32 wx, int32 wy, int32 wz,            ///< [INPUT]
                                         int32 ax, int32 ay, int32 az,            ///< [INPUT]
                                         int16 mx, int16 my, int16 mz,            ///< [INPUT]
                                         int8 temperature, uint8 updateRate, uint16 reserved1,
                                         uint16 simpleChecksum  ///< [INPUT]
) {
    Ep_Combo ep_Combo;
    Ep_Header headerOut;
 ...
 * @section Write_Ep_*() Example
   ...
   @endcode
 */
int EasyObjectDictionary::Write_Ep_Request(EP_ID_TYPE_ toId,        ///< [INPUT]
 ...
 * @endcode
 */
int EasyObjectDictionary::Read_Ep_Request(Ep_Request* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Ack(Ep_Ack* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Status(Ep_Status* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Raw_GyroAccMag(Ep_Raw_GyroAccMag* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Q_s1_s(Ep_Q_s1_s* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Euler_s1_s(Ep_Euler_s1_s* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Q_s1_e(Ep_Q_s1_e* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Euler_s1_e(Ep_Euler_s1_e* dataOut) {
...
int EasyObjectDictionary::Read_Ep_RPY(Ep_RPY* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Gravity(Ep_Gravity* dataOut) {
...
int EasyObjectDictionary::Read_Ep_Combo(Ep_Combo* dataOut) {
 ...
 */
int EasyObjectDictionary::EOD_DB_FindKey(EP_CMD_TYPE_ cmdIn  ///< [INPUT] the search keyword cmd
) {
 ...
 *         EP_FAIL_            cmd does not exist in the object dictionary
 */
int EasyObjectDictionary::EOD_DB_SetReadProtect(EP_CMD_TYPE_ cmdIn,  ///< [INPUT] the search keyword cmd
 ...
 */
int EasyObjectDictionary::Read(EP_CMD_TYPE_ cmdIn,  ///< [INPUT]  Identifier to specify which object in the dictionary
 ...
 *         EP_MUTEX_LOCKED_    Read permission denied.
 */
int EasyObjectDictionary::Read_Header(EP_CMD_TYPE_ cmdIn,   ///< [INPUT]   Specify the Object where to read the header
 ...
 */
int EasyObjectDictionary::Write(char* dataIn,         ///< [INPUT] The data array
                                int lengthIn,         ///< [INPUT] Size of the input data array
 ...
 */
int EasyObjectDictionary::Write_Header_toId(EP_CMD_TYPE_ cmdIn,  ///< [INPUT]
