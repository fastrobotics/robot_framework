...
TEST(BasicGlobalPoseProcess, BasicConversionTests) {
  ...
  ASSERT_LT(global_pose.pose.covariance
                .covariance[GeometryMsgs::PoseWithCovarianceMsg::COV_ROLL],
            0.0);
  ASSERT_LT(global_pose.pose.covariance
                .covariance[GeometryMsgs::PoseWithCovarianceMsg::COV_PITCH],
            0.0);
  ASSERT_LT(global_pose.pose.covariance
                .covariance[GeometryMsgs::PoseWithCovarianceMsg::COV_YAW],
            0.0);
}