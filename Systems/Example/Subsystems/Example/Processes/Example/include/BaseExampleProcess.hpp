...
namespace fast::rf::ExampleSystem::ExampleSubsystem::Example {
    /**
     * @brief Base Example Process
      @details Concrete Example Processes should derive from this
     *
     */
    class BaseExampleProcess : public IExampleProcess {
       public:
        /**
         * @brief Construct a new Base Example Process object
         *
         */
        BaseExampleProcess()
            : m_systemId(fast::rf::ExampleSystem::SYSTEM_ID),
              m_subSystemId(fast::rf::ExampleSystem::ExampleSubsystem::SUBSYSTEM_ID),
              m_processId(fast::rf::ExampleSystem::ExampleSubsystem::Example::PROCESS_EXAMPLE_ID),
