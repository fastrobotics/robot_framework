...
struct PoseWithCovarianceMsg {
    static inline constexpr uint16_t COV_X = Covariance6DMsg::X1;  //!< Covariance Index representing X Position.
    static inline constexpr uint16_t COV_Y = Covariance6DMsg::X2;  //!< Covariance Index representing Y Position.
    static inline constexpr uint16_t COV_Z = Covariance6DMsg::X3;  //!< Covariance Index representing Z Position.
    static inline constexpr uint16_t COV_ROLL =
        Covariance6DMsg::X4;  //!< Covariance Index representing Roll Orientation.
    static inline constexpr uint16_t COV_PITCH = Covariance6DMsg::X5;  //!< Covariance Index representing Pitch
                                                                       //!< Orientationn.
    static inline constexpr uint16_t COV_YAW = Covariance6DMsg::X6;  //!< Covariance Index representing Yaw Orientation.
